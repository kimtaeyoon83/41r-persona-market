...
> **현재 시점 기준**: 2026-05-11. 컴패니언 문서로 [`HOW-IT-WORKS.md`](HOW-IT-WORKS.md) (주제별 deep-dive) + [`CLAUDE.md`](../CLAUDE.md) (운영 가이드 + Do-NOT) 참조. 이 문서는 chronological pipeline trace 관점에 초점.
