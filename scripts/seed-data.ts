...
const TESTER_PROFILES = {
  alice: {
    ...
    profile: {
      expertise: ['DeFi', 'DEX', 'yield farming', 'smart contracts'],
      experience_level: 'expert',
      preferred_domains: ['DeFi', 'trading', 'analytics'],
  ...
  bob: {
    ...
    profile: {
      expertise: ['NFT', 'gaming', 'metaverse', 'social tokens'],
  ...
  charlie: {
    ...
    profile: {
      expertise: ['security', 'smart contracts', 'auditing', 'penetration testing'],
      experience_level: 'expert',
      preferred_domains: ['DeFi', 'infrastructure', 'wallets'],
  ...
  diana: {
    ...
    profile: {
      expertise: ['UX design', 'accessibility', 'onboarding'],
      experience_level: 'intermediate',
      preferred_domains: ['consumer apps', 'wallets', 'marketplaces'],
  ...
  evan: {
    ...
    profile: {
      expertise: ['performance testing', 'load testing', 'API testing'],
      experience_level: 'beginner',
      preferred_domains: ['infrastructure', 'APIs', 'backends'],
